...
@testset "detector" begin
    ...
    res1, g1 = getgrad_three_layer(method=:treeverse, target_pulses=target_pulses, detector_locs=detector_locs, c0=copy(c0))
    res2, g2 = getgrad_three_layer(method=:bennett, target_pulses=target_pulses, detector_locs=detector_locs, c0=copy(c0))
