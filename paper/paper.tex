...
\end{tikzpicture}
    ...
    Using (a) checkpointing scheme and (b) reverse computing scheme to avoid caching all intermediate states. The black arrows are regular forward computing, red arrows are gradient back propagation,
    and blue arrows are combinations of back propagation and reverse computing. The numbers above the arrows are the execution order.
    Black and white circles represents cached states and not cached states (or those states deallocated using reversed computing).
