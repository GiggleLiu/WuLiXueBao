...
文章回顾并探讨自动微分重要的应用之一，对物理模拟过程的自动微分，主要是对电磁学，海洋学~\cite{Heimbach2005}和地震学~\cite{Symes2007,Zhu2020}等问题中最核心的微分方程求解过程的自动微分。
...
后来，有人把机器学习中的最优检查点算法带入到了物理模拟的反向自动微分中~\cite{Symes2007}，仅引入对数的额外时间和空间开销就做到了严格求导。也有一些人利用基于源代码变换和检查点算法~\cite{Griewank1992,Forget2015}的自动微分编译器，如Tapenade~\cite{Hascoet2013}, OpenAD~\cite{Utke2008}和TAF~\cite{Heimbach2005}等工具对物理模拟过程微分。
