...
@i function lorentz!(y!::P3{T}, t, y::P3{T}) where T
...
@i function rk4_step!(f, y!::T, y::T; Δt, t) where T
    @routine @invcheckoff begin
...
@i function rk4!(f, history, y0::T; Δt, Nt) where T
    history[1] += y0
    @invcheckoff @inbounds for i=1:Nt
        rk4_step!(f, history[i+1], history[i]; Δt=Δt, t=(i-1)*Δt)
    end
end
